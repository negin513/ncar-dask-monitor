...
|---------------------  Instructions  -----------------------------|
|------------------------------------------------------------------|
Extract Casper job statistics and memory usage.
...
To see the available options:
    ...
    casper_resource_monitor --help

Examples:
    casper_resource_monitor --start_date 20230304 --end_date 20230314
...
def main():
    """
    Main function for extracting Casper job statistics.
    """
